...
variable "access_group" {
  ...
  default     = "monaro-risk-dev@google.com"
}
...
variable "cloud_run_image" {
  ...
  default     = "australia-southeast1-docker.pkg.dev/monaro-risk-dev/cloud-run-source-deploy/monaro-risk-dash-dev:latest"
}
